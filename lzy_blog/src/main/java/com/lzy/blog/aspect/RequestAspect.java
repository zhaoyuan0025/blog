...
import com.lzy.blog.utils.ThreadLocalContext;
...
public class RequestAspect {
     ...
     */
    @Pointcut("execution( * com.lzy.*.controller..*(..))")
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        //指定包名异常
        String exception = StringUtils.getPackageException(e, "com.lzy");
